...
//----------------------------------------------------------------------------------------------------------
{
    ...
    //------------------------------------------------------------------------------------------------------
    {
        ...
        if ( object.identity && ( Neo4J.isInt(object.identity) || isNeo4JInt(object.identity) ) ) {
    ...
    //------------------------------------------------------------------------------------------------------
    {
        ...
        if ( Array.isArray(data) ) {
            return this.fromArray(data).map((item: Neo4JEntityModel) => {
                return item.toObject();
            });
        }

        return this.fromObject(data).toObject();
    }
}
